...
get_db_table = function(csvv, region, clim, covars, age, args) {
  ...
  mmt = mapply_curve(csvv=csvv, climtas=covars$climtas, loggdppc=covars$loggdppc,
                     age=age, year=years, regions=region, base_year=base_year, func=get.clipped.curve.mortality.mmt, het.list=het.list,
                     TT_lower_bound=TT_lower_bound, TT_upper_bound=TT_upper_bound, TT_step=TT_step,
